...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Controle de Clientes - Actual");
        setResizable(false);
        ...
        Desktop.setPreferredSize(new java.awt.Dimension(650, 468));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/SIMATICKeyvisualLarge.jpg"))); // NOI18N

        lblusuario.setFont(new java.awt.Font("Cambria", 1, 18)); // NOI18N
        lblusuario.setText("Usuário");

        lblData.setFont(new java.awt.Font("Cambria", 1, 18)); // NOI18N
        ...
        setSize(new java.awt.Dimension(864, 527));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void MenCadUsuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenCadUsuActionPerformed
        // as linhas abaixa abrir o formulario de cadastro de tela de usuario
        // dentro do desktop pane
    ...
    private void MenOpcSaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenOpcSaiActionPerformed
       //exibe uma caixa de dialogo com a opção sim ou não
       
       int sair = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja sair?", "Atenção", JOptionPane.YES_NO_OPTION);
       if ( sair == JOptionPane.YES_OPTION){ // se usuario clicar no sim
